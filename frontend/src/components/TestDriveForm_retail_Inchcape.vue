  ...
  export default {
    data() {
      return {
        ...
        modelosPorMarca: {
            "Subaru": ["OUTBACK 2.5i TOURING", "FORESTER 2.0 HYBRID PRIME", "FORESTER 2.5 EYESIGHT", "CROSSTREK 2.0i PREMIUM HEV", "CROSSTREK 2.0I-S ES CVT", "EVOLTIS 2.4 TURBO TOURING"],
            "Suzuki": ["NEW SWIFT 1.2 HYBRID", "FRONX HB 4X2 GLX MT", "JIMNY 5P GLX MT", "JIMNY 5P GLX AT", "GRAND VITARA HB 4X2 GLX AT", "GRAND VITARA HB 4X4 GLX AT", "NEW SCROSS GLX HB 4X2 MT", "NEW SCROSS GLX HB 4X2 AT"],
            "Citroen": ["C3 FEEL", "C3 Aircross FEEL 7P", "C3 Aircross FEEL 5P", "C3 Aircross SHINE 5P"],
            "Great Wall": ["H6 HEV 4X2 TOP", "Jolion HEV 4X2 HIGH", "Jolion Pro HEV 4X2 HIGH", "ORA03 MID", "Tank 300 HEV MID"],
        },
